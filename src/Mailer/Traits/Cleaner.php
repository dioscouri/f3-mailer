...
trait Cleaner
{
    ...
    public static function isEmailAddress($email)
    {
        ...
        /*
         * Check the local address We're a bit more conservative about what constitutes a "legal" address, that is, A-Za-z0-9!#$%&\'*+/=?^_`{|}~- Also, the last character in local cannot be a period ('.')
         */
        $allowed = 'A-Za-z0-9!#&*+=?_-';
