...
class Base extends \Prebase
{
     ...
     * @param
     *            Object is a Row from the table #__messagebottle_emails
     * @since 0.1
     * @return Object
     */
     ...
     * @example $this->getSender($row);
     * @param
     *            Object is a Row from the table #__users
     * @since 0.1
     * @return Object @used-by $this->getSender ,$this->getSender getReceiver
     */
     ...
     * '/components/com_messagebottle/tables');
     ...
     * @param
     *            array of event ids emailed via the queue
     * @since 0.1
     * @return object
     *
     */
    ...
    /**
     * The is the main function, and should be the only function called directly when running this class.
