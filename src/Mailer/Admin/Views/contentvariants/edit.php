    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="#tab-basics" data-toggle="tab"> Email </a>
                </li>
                <li>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab-basics">
                    ...
                    <?php echo $this->renderLayout('Mailer/Admin/Views::contentvariants/fields_basics.php'); ?>
                ...
                <div class="tab-pane" id="tab-settings">
                    ...
                    <?php echo $this->renderLayout('Mailer/Admin/Views::contentvariants/fields_settings.php'); ?>
